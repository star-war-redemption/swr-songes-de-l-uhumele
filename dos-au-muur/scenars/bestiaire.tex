...
\begin{figure}[h!]
    \centering
    \includegraphics[height=200pt]{_img/dos-au-muur/contrebandier.png}
\end{figure}
\paragraph{Background}
...
\begin{figure}[h!]
    \centering
    \includegraphics[height=200pt]{_img/dos-au-muur/wampa.png}
\end{figure}
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=\linewidth]{_img/dos-au-muur/cybercleps.png}
\end{figure}
\paragraph{Background}
