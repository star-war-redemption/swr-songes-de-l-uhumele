...
\hypersetup{
	...
	pdfsubject={Star Wars Redemption, Songes de l’Uhumele, version 1.0.2},
	pdfauthor={Marthym},
	pdfkeywords={star,wars,savage,worlds,jdr,scenario,uhumele,jdrp,jdra}
}
...
\begin{document}
	...
	\begin{tikzpicture}[overlay]
		\node[minimum width=200pt,minimum height=200pt] at (15,11){\includegraphics[width=240pt]{_img/uhumele.png}};
	\end{tikzpicture}}
	\end{titlepage}
	...
	\section{Contexte du Scénario}
		\begin{wrapfigure}{R}{180pt}
			\centering
			\includegraphics[width=180pt]{_img/bomo-greenbark.png}
	...
	\begin{figure}[!h]
		...
		\begin{tikzpicture}[overlay, anchor=north]
			\node[rotate=90] at (-10,-11.5) {\includegraphics[width=1.05\textheight]{_img/forteresse-esseles-light.png}};
		\end{tikzpicture}
	\end{figure}
	\twocolumn
	...
	Ici aussi les joueurs ont le choix de rentrer en force ou en mode infiltration. \'A vous de doser la difficulté en fonction de vos joueurs. L’armée de \textbf{Dezono Qua} est composée de \nameref{sec:droide-b1} et de \nameref{sec:droideka}. Dezono possède aussi un Droïde de Protocole qui reste avec lui en permanence.
